...
export default function ContactPage() {
  ...
  const handleWhatsAppContact = () => {
    const whatsappMessage = `Hello! I'm interested in learning about your Islamic education programs at Al-Azhar School.`;
    const whatsappUrl = `https://wa.me/447123456789?text=${encodeURIComponent(whatsappMessage)}`;
                  ...
                  <div className="space-y-8 flex-grow">
                    ...
                    <div className="flex items-start space-x-4 group">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-2 text-sm leading-relaxed">002- 01023594533</p>
